...
SEFAZ PI Visualizar certidões CNDA: CND segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_pi_visualizar_cert@mcp.ai](mailto:sefaz_pi_visualizar_cert@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
